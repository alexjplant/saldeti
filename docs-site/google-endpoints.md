---
title: Google Endpoints
description: Complete reference of all 171 implemented Google Workspace API endpoints across Admin Directory, Reports, Cloud Identity, Groups Settings, Data Transfer, and Workspace Events services.
---

# Google Workspace API Endpoints

The following tables document every implemented Google Workspace API endpoint in the Saldeti simulator, organized by tier. These endpoints span the Admin Directory API, Reports API, Cloud Identity API, Groups Settings API, Data Transfer API, and Workspace Events API.

For base URL, authentication, scopes, and common query parameters, refer to the Google Workspace API documentation.
...
| Tier | Category | Endpoints |
|------|----------|-----------|
| 1 | Authentication, Users, Groups, Members | 37 |
| 2 | Org Units, Roles, Role Assignments, Privileges | 17 |
| 3 | Customers, Domains, Domain Aliases | 11 |
| 4 | Chrome OS, Mobile, Cloud Identity Devices | 27 |
| 5 | Cloud Identity Groups, Memberships | 20 |
| 6 | Activity Reports, Usage Reports | 5 |
